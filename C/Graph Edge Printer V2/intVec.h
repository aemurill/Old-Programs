/* intVec.h
 * Stores Vector information in stack form, as well as 
 * reallocating the data when effecient
 * Modified by Axel E Murillo (aemurill)
 */
...
/** intTop()
 * precondition: myVec is not empty.
 */
